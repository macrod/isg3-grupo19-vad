...
<html>
	...
	<body leftmargin=0 topmargin=0>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr bgcolor="#3980F4">
				<td width="60%" height="20" align="left" class="ruta">&nbsp;Está Vd. en: INICIO </td>
				<td width="30%" align="right" class="texto_min_1_b">&nbsp;</td>
				<td width="10%" align="right"><a class="texto_min_1_b" href="javascript:window.parent.location.href='VaD_Ayuda.htm';">Ayuda</a></td>
			</tr>
		</table>
	</body>
</html>