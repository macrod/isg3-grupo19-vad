...
System.out.println("Estamos en  SVL_Registro_VO_2.jsp");
			...
			%>
						...
						<tr><td colspan="6">
							<table width="100%" cellpadding="0" cellspacing="0">
								<tr>
									<td align="right"><button class="boton_general" type="button" onclick="javascript:alert('Datos grabados correctamente!!');window.parent.location.href='Inicio.htm;">Grabar Servicios</button></td>
								</tr>
							</table>							
						</td></tr>
					</table>
