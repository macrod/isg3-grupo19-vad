...
<html>
	...
	<body leftmargin=0 topmargin=0>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr bgcolor="#3980F4">
				<td width="60%" height="20" align="left" class="ruta">&nbsp;Está Vd. en: <a href="javascript:window.parent.location.href='Inicio.jsp';" class="texto_min_1_b">INICIO</a> - <a href="javascript:window.parent.location.href='VaD_Inicio_VO.jsp';" class="texto_min_1_b">Voluntarios</a> - Proponer Servicios</td>
