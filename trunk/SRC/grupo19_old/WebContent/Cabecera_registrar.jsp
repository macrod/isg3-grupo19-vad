...
<html>
	...
	<body leftmargin=0 topmargin=0>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr bgcolor="#3980F4">
				<td width="60%" height="20" align="left" class="ruta">&nbsp;Está Vd. en: <a href="javascript:window.parent.location.href='VaD_Logar_Registrar.jsp';" class="texto_min_1_b">INICIO</a> - REGISTRAR&nbsp;</td>
				<td width="30%" align="right" class="texto_min_1_b"><% if (usuario!=null) { %><%=nombre%>&nbsp;&nbsp;&nbsp;<% } %></td>
