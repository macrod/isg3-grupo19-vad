...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
	<tr bgcolor="#3980F4">
		<td width="60%" height="20" align="left" class="ruta">&nbsp;Est Vd. en: INICIO - DEMANDANTES</td>
...
<div id="contenedorInicio">
    ...
    <td align="center" valign="middle"><span class="demandantes"><a href="javascript:window.parent.location.href='FrontController?accion=solicitudservicio';">Solicitud de Servicios</a></span></td>
    ...
    <tr>
    <td>&nbsp;</td>
    <td align="center" valign="middle"><span class="alertas"><a href="javascript:window.parent.location.href='FrontController?accion=valorarservicios';">Valorar Servicios </a></span></td>
    <td align="center" valign="middle">&nbsp;</td>
