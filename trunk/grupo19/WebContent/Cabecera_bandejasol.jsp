...
<html>
	...
	<body leftmargin=0 topmargin=0>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr bgcolor="#3980F4">
				<td width="60%" height="20" align="left" class="ruta">&nbsp;Está Vd. en: <a href="javascript:window.parent.location.href='Index.htm';" class="texto_min_1_b">INICIO</a> - <a href="javascript:window.parent.location.href='VaD_Inicio_VO.jsp';" class="texto_min_1_b">Voluntarios</a> - Bandeja de Solicitudes</td>
				<td width="30%" align="right" class="texto_min_1_b"><% if (usuario!=null) { %><%=nombre%>&nbsp; - <%=perfil%>&nbsp;&nbsp;<% }else { %><a class="texto_min_1_b" href="javascript:window.parent.location.href='FrontController?accion=logar&adonde=inicio';">Login</a><% } %>&nbsp;</td>
